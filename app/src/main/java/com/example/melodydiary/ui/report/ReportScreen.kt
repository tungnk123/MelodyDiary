...
fun DiaryCountWrapper(
    ...
    Row(
        ...
        Column(
            ...
            Text(
                text = stringResource(com.example.melodydiary.R.string.title_nhat_ky),
        ...
        Column(
            ...
            Text(
                text = stringResource(com.example.melodydiary.R.string.title_chuoi_ghi_lien_tuc),
                style = MaterialTheme.typography.bodyMedium
            )
        }
    }
...
fun BieuDoTamTrang(
    ...
    Column(
        ...
        Text(
            text = stringResource(com.example.melodydiary.R.string.title_bieu_do_tam_trang),
...
fun ThongKeTamTrang(
    ...
    Column(
        ...
        Text(
            text = stringResource(com.example.melodydiary.R.string.title_thong_ke_tam_trang),
            style = MaterialTheme.typography.titleMedium,
            modifier = Modifier.padding(start = 24.dp)
        )
        Spacer(modifier = Modifier.height(10.dp))
